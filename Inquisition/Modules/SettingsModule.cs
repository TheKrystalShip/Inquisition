...
namespace TheKrystalShip.Inquisition.Modules
{
    public class SettingsModule : ModuleBase<SocketCommandContext>
    {
        ...
        public SettingsModule(DatabaseContext dbContext, ReportHandler reportHandler, DiscordSocketClient client, PrefixHandler prefixHandler, ILogger<SettingsModule> logger)
        {
    ...
    public class SetSettingsModule : ModuleBase<SocketCommandContext>
    {
        ...
        public SetSettingsModule(DatabaseContext dbContext, ReportHandler reportHandler, PrefixHandler prefixHandler, ILogger<SetSettingsModule> logger)
        {
            _dbContext = dbContext;
            _reportHandler = reportHandler;
            _prefixHandler = prefixHandler;
