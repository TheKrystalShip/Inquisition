...
using Inquisition.Data.Properties;
...
namespace Inquisition.Data.Handlers
{
	public class EmailHandler
	{
		...
		private string XSLFile = "Data\\XSL.xslt";
		...
		public static void Send(Report report)
			=> new Thread(new EmailHandler().SendReport).Start(report);

		private void SendReport(object parameter)
		{
			try
			{
